...
- Version: `0.1.0`
- Stage: modular research prototype with traceable summary and translation harnesses
- Current focus: supervised DeepSeek benchmarks, selective translation, and evidence-backed conversation
- Last synced: `2026-05-31T15:52:51+08:00`
...
6. Benchmark the optional Docling parser and OCRmyPDF preprocessing route on real papers.
7. Run supervised DeepSeek summary and selective-translation benchmarks.
8. Extend local chunk retrieval with optional embeddings and richer ranking.
9. Add a conversation agent that can cite folder evidence.
