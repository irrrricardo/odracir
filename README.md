...
- Version: `0.1.0`
- Stage: modular research prototype with traceable summaries, translations, and cited questions
- Current focus: supervised DeepSeek benchmarks, document-adapter benchmarks, and skill manifests
- Last synced: `2026-05-31T16:13:23+08:00`
...
6. Benchmark the optional Docling, PyMuPDF4LLM, and OCRmyPDF routes on representative papers.
...
9. Add a research-companion agent that reuses the audited ask and retrieval paths.
10. Add planning tools for reading paths, reproduction, and experiments.
11. Add code assistance tools after research memory is stable.
12. Split into multiple agents only when the single-agent prompt becomes too large or conflicted.
