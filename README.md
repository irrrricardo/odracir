...
- Version: `0.1.0`
- Stage: modular single-agent prototype with parser registry, status reporting, and traceable chunking
- Current focus: reliable ingestion, normalized PDF text artifacts, OCR detection, and page-traceable chunks
- Last synced: `2026-05-30T16:10:08+08:00`
...
8. Add retrieval over the JSON index and paper text.
